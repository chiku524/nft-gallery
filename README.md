...
**Galleria On Ink** is the thirteenth: 24 unique looping paintings on Ink (chain ID `57073`). Each work is painted by its own engine and minted as an open edition. No trait stack. No shared house style.
...
| `/galleria` | Galleria On Ink salon, 24 open-edition 1:1 loops, OpenSea notes |
...
Requires Python 3 with Pillow and NumPy. See `docs/loopkins.md`, `docs/afterimages.md`, `docs/inklings.md`, `docs/wicklings.md`, `docs/purrkins.md`, `docs/hoodkins.md`, `docs/birbs.md`, `docs/shookums.md`, `docs/foxins.md`, `docs/santapaws.md`, `docs/scribblins.md`, `docs/groovy.md`, and `docs/galleria.md` for OpenSea Drop upload steps.
...
`npm run generate:galleria` paints all 24 independent salon works, brand assets, and the OpenSea GIF + CSV pack.
