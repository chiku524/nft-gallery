...
const nextConfig: NextConfig = {
  images: {
    localPatterns: [
      ...
      { pathname: "/foxins-traits/**", search: "?v=*" },
      { pathname: "/opaline-traits/**", search: "?v=*" },
    ],
  },
  async redirects() {
    return [
      ...
      { source: "/foxkins", destination: "/foxins", permanent: true },
      { source: "/foxkins/:path*", destination: "/foxins/:path*", permanent: true },
    ];
  },
};
