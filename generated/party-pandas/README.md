...
16 flattened party-panda loops at 512×512, 12 frames, 80ms.

Upload every file in `gifs/` (1.gif–4444.gif) plus `PARTY-PANDAS-opensea-drop.csv` or `opensea-metadata.csv` to an OpenSea Drop on Base (chain ID 8453).
