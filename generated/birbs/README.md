...
16 flattened BirbNation loops at 512×512, 12 frames, 90ms.

Upload every file in `gifs/` (1.gif–16.gif) plus `BIRBS-opensea-drop.csv` or `opensea-metadata.csv` to an OpenSea Drop on Robinhood Chain (chain ID 4663).
