...
export function PurrkinsHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/80 bg-[color-mix(in_oklch,var(--background)_88%,#0d221e)]/90 backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6">
        <Link href={purrkinsPath()} className="flex items-center gap-3">
          <ApngImage
            src="/brand/logo-purrkins.png"
            alt=""
            width={40}
            height={40}
          ...
          <div className="leading-tight">
            <p className="font-heading text-lg tracking-tight">{purrkins.name}</p>
        ...
        <div className="flex items-center gap-2">
          <Button asChild size="sm" className="hidden sm:inline-flex">
            <Link href={purrkinsPath("/studio")}>Studio</Link>
          </Button>
          <Sheet>
            ...
            <SheetContent side="right" className="w-72">
              <SheetHeader>
                <SheetTitle>{purrkins.name}</SheetTitle>
              </SheetHeader>
              <div className="mt-6 flex flex-col gap-2 px-4">
                ...
                <Link href={purrkinsPath("/studio")} className="rounded-xl px-3 py-2 text-base hover:bg-secondary">
                  Studio
                </Link>
              </div>
            </SheetContent>
