export const opaline = {
  name: "Opaline",
  symbol: "OPAL",
  tagline: "Eight glass beasts. Iridescent film. One shared clock.",
  description:
    "Opaline is a 10,000-piece collection of looping smoked-glass PFP GIFs. Each portrait is stacked from seven layers — atelier, vapor, cast, sheen, regard, crest, and clasp — then flattened onto one 12-frame GIF. Eight crystal beasts. Dichroic film. Editorial light.",
  story:
