...
export const inklingSamples: InklingSample[] = [
  {
    ...
    attributes: [
      ...
      { trait_type: "Visage", value: "Bobtail" },
      { trait_type: "Gaze", value: "Bright" },
      { trait_type: "Mark", value: "Clean mantle" },
      { trait_type: "Adorn", value: "Kelp Flow" },
    ],
  },
  {
    id: 2,
    ...
    attributes: [
      ...
      { trait_type: "Visage", value: "Reef" },
      { trait_type: "Gaze", value: "Lidded" },
      { trait_type: "Mark", value: "Red Seal" },
      { trait_type: "Adorn", value: "Pearl Cluster" },
    ],
  },
  {
    id: 3,
    ...
    attributes: [
      ...
      { trait_type: "Visage", value: "Dumbo" },
      { trait_type: "Gaze", value: "Dew" },
      { trait_type: "Mark", value: "Ink Splash" },
      { trait_type: "Adorn", value: "Bare mantle" },
    ],
  },
  {
    id: 4,
    ...
    attributes: [
      ...
      { trait_type: "Visage", value: "Cuttle" },
  ...
  },
  {
    ...
    attributes: [
      ...
      { trait_type: "Visage", value: "Firefly" },
