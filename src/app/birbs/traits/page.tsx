...
import { BIRB_DURATION_MS, BIRB_FRAMES, birbTraitCategories } from "@/data/birb-traits";
import { birbs } from "@/data/birbs";

export const metadata: Metadata = {
  title: "Trait loops",
  description: "Every round-borb robin trait layer in the BirbNation stack.",
};

export default function BirbsTraitsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Each file is an APNG on a {birbs.canvas}×{birbs.canvas} canvas: {BIRB_FRAMES} frames,{" "}
        {BIRB_DURATION_MS}ms, looping. Studio stacks field → plumage → mug → accent. Eyes blink.
        Wings twitch. Accents bob. The sphere stays put.
      </p>
