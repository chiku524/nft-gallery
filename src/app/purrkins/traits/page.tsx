...
import { PURRKIN_DURATION_MS, PURRKIN_FRAMES, purrkinTraitCategories } from "@/data/purrkin-traits";
import { purrkins } from "@/data/purrkins";

export const metadata: Metadata = {
  title: "Trait loops",
  description: "Every chibi-cat trait layer in the Purrkins stack.",
};

export default function PurrkinsTraitsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Each file is an APNG on a {purrkins.canvas}×{purrkins.canvas} canvas: {PURRKIN_FRAMES} frames,{" "}
        {PURRKIN_DURATION_MS}ms, looping. Studio stacks pad → glow → pelt → fit → mug → gear.
        Pelt, fit, mug, and gear share one bob so the cat stays locked.
      </p>
