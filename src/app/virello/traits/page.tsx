...
import { VIRELLO_DURATION_MS, VIRELLO_FRAMES, virelloTraitCategories, virelloTraitSrc } from "@/data/virello-traits";
import { virello } from "@/data/virello";

export const metadata: Metadata = {
  title: "Trait loops",
  description: "Every wind-up tin-toy trait layer in the Virello stack.",
};

export default function VirelloTraitsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Each file is an APNG on a {virello.canvas}×{virello.canvas} canvas: {VIRELLO_FRAMES} frames,{" "}
        {VIRELLO_DURATION_MS}ms, looping. Studio stacks bench → chassis → enamel → decal → key →
        spark → wear. The tin stays stamped. The wind-up is the key.
      </p>
