...
const steps = [
  ...
  },
  {
    ...
    body: "Upload every file in generated/wicklings/gifs (1.gif–8888.gif) and generated/wicklings/WICKLINGS-opensea-drop.csv. The CSV already uses OpenSea’s required headers (tokenID, name, description, file_name, attributes[Trait]). OpenSea plays GIF, not APNG. Preview the loops, then publish.",
  },
  {
