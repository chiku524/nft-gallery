...
import { RISOTA_DURATION_MS, RISOTA_FRAMES, risotaTraitCategories } from "@/data/risota-traits";
import { risota } from "@/data/risota";

export const metadata: Metadata = {
  title: "Trait loops",
  description: "Every risograph trait layer in the Risota stack.",
};

export default function RisotaTraitsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Each file is an APNG on a {risota.canvas}×{risota.canvas} canvas: {RISOTA_FRAMES} frames,{" "}
        {RISOTA_DURATION_MS}ms, looping. Studio stacks stock → screen → figure → pass → knockout → slug → mark.
        Pass plates slide. Slugs sit on one crown. The dancer stays put.
      </p>
