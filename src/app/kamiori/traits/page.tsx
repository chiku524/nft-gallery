...
import { KAMIORI_DURATION_MS, KAMIORI_FRAMES, kamioriTraitCategories } from "@/data/kamiori-traits";
import { kamiori } from "@/data/kamiori";

export const metadata: Metadata = {
  title: "Trait loops",
  description: "Every origami trait layer in the Kamiori stack.",
};

export default function KamioriTraitsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Each file is an APNG on a {kamiori.canvas}×{kamiori.canvas} canvas: {KAMIORI_FRAMES} frames,{" "}
        {KAMIORI_DURATION_MS}ms, looping. Studio stacks pulp → fleck → fold → score → facet → seal →
        draft. The fold stays put. A draft lifts one corner.
      </p>
