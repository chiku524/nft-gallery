...
import { UMBRA_DURATION_MS, UMBRA_FRAMES, umbraTraitCategories } from "@/data/umbra-traits";
import { umbra } from "@/data/umbra";

export const metadata: Metadata = {
  title: "Trait loops",
  description: "Every shadow-puppet trait layer in the Umbra stack.",
};

export default function UmbraTraitsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Each file is an APNG on a {umbra.canvas}×{umbra.canvas} canvas: {UMBRA_FRAMES} frames,{" "}
        {UMBRA_DURATION_MS}ms, looping. Studio stacks cloth → ember → cast → hinge → cutwork → leaf →
        soot. The hide stays put. Hinges swing the dance.
      </p>
