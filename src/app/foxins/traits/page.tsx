...
import { FOXIN_DURATION_MS, FOXIN_FRAMES, foxinTraitCategories } from "@/data/foxin-traits";
import { foxins } from "@/data/foxins";

export const metadata: Metadata = {
  title: "Trait loops",
  description: "Every bold-graphic fox trait layer in the Foxins stack.",
};

export default function FoxinsTraitsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Each file is an APNG on a {foxins.canvas}×{foxins.canvas} canvas: {FOXIN_FRAMES} frames,{" "}
        {FOXIN_DURATION_MS}ms, looping. Studio stacks field → pelt → mug → hat → wrap → charm. Eyes
