...
Looping **paper-lantern PFP GIFs** — soft discs, translucent paper, a little flame with a face. An **8,888-piece** collection built to mint on **Arbitrum** (chain ID `42161`) and list on **OpenSea**.
...
python3 scripts/generate_wicklings.py --all  # full 8,888
