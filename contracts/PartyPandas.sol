...
/// @title Party Pandas
/// @notice 4,444 looping party-panda PFP GIFs for Base (chain ID 8453).
contract PartyPandas is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Party Pandas", "PAND") Ownable(msg.sender) {
