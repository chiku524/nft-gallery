...
/// @title Inklings
/// @notice 5,555 looping ink-wash PFP GIFs for Ink (chain ID 57073).
contract Inklings is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Inklings", "INKL") Ownable(msg.sender) {
