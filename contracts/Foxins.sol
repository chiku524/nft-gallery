...
/// @title Foxins
/// @notice 5,555 looping bold-graphic fox PFP GIFs for Base (chain ID 8453).
contract Foxins is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Foxins", "FOXI") Ownable(msg.sender) {
