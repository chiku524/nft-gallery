...
/// @title SantaPaws
/// @notice 7,777 looping chibi-cat PFP GIFs for Base (chain ID 8453).
contract SantaPaws is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Santa Paws", "PAWS") Ownable(msg.sender) {
