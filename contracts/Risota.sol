...
/// @title Risota
/// @notice 8,888 looping risograph PFP GIFs for Robinhood Chain (chain ID 4663).
contract Risota is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Risota", "RISO") Ownable(msg.sender) {
