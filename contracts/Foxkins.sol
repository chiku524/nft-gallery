...
/// @title Foxkins
/// @notice 5,555 looping clay fox PFP GIFs for Base (chain ID 8453).
contract Foxkins is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Foxkins", "FOXK") Ownable(msg.sender) {
