...
/// @title Scribblins
/// @notice 5,555 looping doodle-critter PFP GIFs for Base (chain ID 8453).
contract Scribblins is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Scribblins", "SCRIB") Ownable(msg.sender) {
