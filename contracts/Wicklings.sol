...
/// @title Wicklings
/// @notice 3,333 looping paper-lantern PFP GIFs for Arbitrum (chain ID 42161).
contract Wicklings is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Wicklings", "WICK") Ownable(msg.sender) {
