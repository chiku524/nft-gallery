...
/// @title Mochins
/// @notice 4,000 looping soft-3D mochi PFP GIFs for Shape (chain ID 360).
contract Mochins is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseTokenURI_) ERC721("Mochins", "MOCHI") Ownable(msg.sender) {
