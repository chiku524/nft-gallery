"""Coarse terrazzo. Independent salon work 207."""
...
WORK = WorkSpec(
    ...
    slug='coarse-pour',
    title='Coarse Pour',
    description='The chips refused to be polite.',
    medium='Coarse terrazzo',
    motion='Heavy',
    palette='Brutal chip',
)
...
def paint(frame: int) -> Image.Image:
    ...
    t = frame / 12 * math.tau
    bg, ink, accent, mid = (32, 54, 37), (223, 201, 218), (141, 175, 30), (127, 127, 127)
